...
const (
	...
	ContextDebug            Hint = C.GLFW_CONTEXT_DEBUG            // Specifies whether to create a debug context.
...
func CreateWindow(width, height int, title string, monitor *Monitor, share *Window) (*Window, error) {
	...
	// rmgo: force per-pixel framebuffer alpha so Fyne text AA blends correctly
	// on the desktop instead of anti-aliasing onto a color-key black fill.
